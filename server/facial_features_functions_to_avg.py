...
def f18(detection_result,image_path):
    return  detection_result.face_landmarks[0][points_data['f18']['points'][0]].z-detection_result.face_landmarks[0][points_data['f18']['points'][1]].z
def f19(detection_result,image_path):
    return detection_result.face_landmarks[0][points_data['f19']['points'][0]].z-detection_result.face_landmarks[0][points_data['f19']['points'][1]].z
...
def f21(detection_result,image_path):
        return analyze_eyebrow_shape(image_path,detection_result)
